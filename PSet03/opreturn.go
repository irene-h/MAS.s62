...
func OpReturnTxBuilder(sendfromtxid string, qty int64) *wire.MsgTx {
	...
	opReturnData := []byte("S62 Irene H MITID 917883246")
	...
	// spending from!
	sendToAddressString := "myvPuUvNJ1yDRphu2Cjy1B8ndCuUH57hcX"
	...
	p2pkhOutput := wire.NewTxOut(qty, sendToScript)
	...
	phraseHash := chainhash.DoubleHashB([]byte("mpQQryVrYmGNPxVqNeE5Rgodvsk25Pihg"))
